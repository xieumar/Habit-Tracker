      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12 lg:p-20 bg-background">
        <div className="w-full max-w-md">
          ...
          <div className="mb-8">
            ...
            <p className="text-muted-text font-medium">Join the sunrise community and start fresh today</p>
          </div>
          ...
          <form onSubmit={handleSubmit} noValidate className="space-y-6">
            ...
            <div>
              <label htmlFor="name" className="block text-xs font-bold text-muted-text uppercase tracking-wider mb-2 ml-1">
                Full Name
              </label>
          ...
          <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-[2.5rem] p-10 text-white shadow-2xl">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-white/60 text-xs font-medium">Empowering rituals</p>
              </div>
            </div>
          </div>
        </div>
